...
# Output file path
output_file = os.path.join(OUTPUT_DIR, "data_results_malaysia_PUb.csv")
...
# --- Pagination loop ---
# Each batch = 100 records → 8631 total means ~87 pages
for start in range(0, 8700, 100):
    url = f"https://lom.agc.gov.my/json-subsid-2024.php?type=pub&start={start}&length=100"
